...
def main():
    ...
    # test_images, labels = val_dataloader.read_batch(200, "test")
    # save_predicted_results(test_images, labels, network, val_dataloader.paths_logger["test"], loss, "before_training", args.output_path)
